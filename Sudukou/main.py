...
class MainGUI:
    ...
    def __init__(self, master):
        ...
        self.button3 = tk.Button(self.master, text="Interactive", font = 40,command=self.interactive_solver, **button_style)
